          ...
          <div class="col-lg-8">
            <div class="review owl-carousel owl-theme">
              <div class="review-item">
                ...
                <p class="desc">Capitalize on low hanging fruit to identify a ballpark value added activity to beta
                  test. Override the digital divide with additional clickthroughs</p>
