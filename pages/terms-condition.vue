<template>
  <div class="container mt-5 pt-5">
    <div class="mt-5 pt-5">
      ...
      <p>Welcome to Organic Verse!</p>

      <p>These terms and conditions outline the rules and regulations for the use of Organic Verse's Website, located at
        organicverse.in.</p>

      <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Organic Verse
      ...
      <p>We employ the use of cookies. By accessing Organic Verse, you agreed to use cookies in agreement with the
        Organic Verse's Privacy Policy. </p>
      ...
      <p>Unless otherwise stated, Organic Verse and/or its licensors own the intellectual property rights for all
        material on Organic Verse. All intellectual property rights are reserved. You may access this from Organic Verse
        for your own personal use subjected to restrictions set in these terms and conditions.</p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Organic Verse</li>
        <li>Sell, rent or sub-license material from Organic Verse</li>
        <li>Reproduce, duplicate or copy material from Organic Verse</li>
        <li>Redistribute content from Organic Verse</li>
      </ul>

      <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a
        href="https://www.termsfeed.com/terms-conditions-generator/">TermsFeed Free Terms and Conditions Generator</a>.
      </p>

      <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. Organic Verse does not filter, edit, publish or review Comments prior to their presence on
        the website. Comments do not reflect the views and opinions of Organic Verse,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, Organic Verse shall not be liable for the Comments or for any liability, damages or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
        website.</p>

      <p>Organic Verse reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>You hereby grant Organic Verse a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Organic
        Verse; and (d) the link is in the context of general resource information.</p>
      ...
      <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
        you must inform us by sending an e-mail to Organic Verse. Please include your name, your organization name,
      ...
      <p>No use of Organic Verse's logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
