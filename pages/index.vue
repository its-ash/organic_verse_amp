      ...
      <div class="container">
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-6 col-md-12 row">
            <div class="banner-img w-100 col-12 pb-5">
              <lottie-player src="/lottie/farmers.json" loop autoplay></lottie-player>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 col-md-12">
            <lottie-player src="/lottie/tractor.json" loop autoplay></lottie-player>
          </div>
        </div>
      </div>
    </section>
